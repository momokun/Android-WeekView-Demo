...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewNextDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NextPreWeekday = getWeekDay(step+=7);
                firstDayOfWeek = CommonMethod.convertWeekDays(NextPreWeekday[0]);
                lastDayOfWeek = CommonMethod.convertWeekDays(NextPreWeekday[6]);
                textViewDate.setText(firstDayOfWeek + "-" + lastDayOfWeek + " "
                        + CommonMethod.convertWeekDaysMouth(NextPreWeekday[6]));
    ...
    public void onClick(View v){
        ...
        switch(v.getId()){
            case R.id.textViewSun:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[0]);
                startActivity(i);
                break;

            case R.id.textViewMon:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[1]);
                startActivity(i);
                break;

            case R.id.textViewTue:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[2]);
                startActivity(i);
                break;

            case R.id.textViewWed:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[3]);
                startActivity(i);
                break;

            case R.id.textViewThu:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[4]);
                startActivity(i);
                break;

            case R.id.textViewFri:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[5]);
                startActivity(i);
                break;

            case R.id.textViewSat:
                i = new Intent(MainActivity.this,AgendaDay.class);
                i.putExtra("dayName",NextPreWeekday[6]);
                startActivity(i);
                break;
        }
    }

    public String[] getWeekDay(int step) {
        Log.d("STEPPER", String.valueOf(step));
        Calendar now = Calendar.getInstance();
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
        String[] days = new String[7];
        int delta = -now.get(GregorianCalendar.DAY_OF_WEEK) + 1 + step;
    ...
    public static WeekSets getWeekValues(String weekDay, String jobId, String jobRefId,
                                         String tapMargina, String buttonHighta) {
        ...
        protected String doInBackground(String... params) {
            try {
               ...
               /* /*//** for tue day
                ...
                weekDatas.add(getWeekValues(String.valueOf(5), "12", "4",
                        tapMargin, buttonHight));*/

                //** for sat day
                tapMargin = getWithAndHigthToButton(1); //ganjil start detik 30
                buttonHight = getHightOfButton(0, 2); // 1 jam
                weekDatas.add(getWeekValues(String.valueOf(6), "12", "Sat",
                        tapMargin, buttonHight));
